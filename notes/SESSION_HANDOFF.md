...
- **FUTURE STEP:** test IB account wiring + price retrieval (Gateway/ib_async connect, pull prices/contract details) — task #18; see notes/production_ib_roadmap.md + ib_canada_instruments_and_data.md.
